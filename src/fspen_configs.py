...
def get_cnn(
    in_channels, kernel_size, padding, stride, out_channels, layers, channel_step=2
):
    ...
    for i in range(1, layers + 1):
        encoder[f"encoder{i}"] = {
            ...
            "out_channels": min(in_channels * step, out_channels),
...
def build_sub_band_decoder_params(
    sbe: Dict[str, dict], width: Tuple[int], overlap=None
):
...
def get_full_band_decoder(full_band_encoder):
    ...
    for i, vals in enumerate(list(full_band_encoder.values())[::-1]):
        full_band_decoder[f"decoder{i}"] = {
            "in_channels": vals["out_channels"] * 2,
            "out_channels": vals["in_channels"],
...
def get_sub_band_encoder(
    widths, sub_band_layers, channels, channel_step=2, overlap=None
):
    start_freq = 0
    sub_band_encoder: Dict[str, dict] = {}
    for i in range(1, len(widths) + 1):
        sub_band_encoder[f"encoder{i}"] = {
            "group_width": widths[i - 1],
            "bounds": {
                "start_frequency": start_freq,
                "end_frequency": start_freq + widths[i - 1],
            },
            "convs": [],
        }
        sub_band_encoder[f"encoder{i}"]["convs"] = list(
            get_cnn(
                in_channels=1,
                kernel_size=4,
                stride=2,
...
class TrainConfig_48kHz_overlap(FSPENBaseConfig):
    ...
    dummy_params: Dict[str, dict] = {
        "encoder1": {
            "group_width": 18,
            "bounds": {"start_frequency": 0, "end_frequency": 18},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder2": {
            "group_width": 18,
            "bounds": {"start_frequency": 18, "end_frequency": 36},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder3": {
            "group_width": 48,
            "bounds": {"start_frequency": 36, "end_frequency": 84},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder4": {
            "group_width": 48,
            "bounds": {"start_frequency": 84, "end_frequency": 132},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder5": {
            "group_width": 66,
            "bounds": {"start_frequency": 132, "end_frequency": 198},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder6": {
            "group_width": 66,
            "bounds": {"start_frequency": 198, "end_frequency": 264},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder7": {
            "group_width": 120,
            "bounds": {"start_frequency": 264, "end_frequency": 384},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder8": {
            "group_width": 129,
            "bounds": {"start_frequency": 384, "end_frequency": 513},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
...
class TrainConfig_48kHz_enc_ext_lay_1_overlap(FSPENBaseConfig):
    ...
    sub_band_encoder: Dict[str, dict] = {
        ...
        "encoder2": {
            "group_width": 27,
            "old_group_width": 18,
            "bounds": {"start_frequency": 9, "end_frequency": 36},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder3": {
            "group_width": 57,
            "old_group_width": 48,
            "bounds": {"start_frequency": 27, "end_frequency": 84},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder4": {
            "group_width": 72,
            "old_group_width": 48,
            "bounds": {"start_frequency": 60, "end_frequency": 132},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder5": {
            "group_width": 90,
            "old_group_width": 66,
            "bounds": {"start_frequency": 108, "end_frequency": 198},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder6": {
            "group_width": 99,
            "old_group_width": 66,
            "bounds": {"start_frequency": 165, "end_frequency": 264},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder7": {
            "group_width": 153,
            "old_group_width": 120,
            "bounds": {"start_frequency": 231, "end_frequency": 384},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
        ...
        "encoder8": {
            "group_width": 189,
            "old_group_width": 129,
            "bounds": {"start_frequency": 324, "end_frequency": 513},
            "convs": [
                {
                    "in_channels": 1,
                    "out_channels": 32,
    ...
    sub_band_decoder: Dict[str, dict] = build_sub_band_decoder_params(
        dummy_params, [6, 6, 6, 6, 6, 6, 12, 16]
    )
...
class TrainConfig_48kHz_enc_ext(FSPENBaseConfig):
    ...
    sub_band_decoder: Dict[str, dict] = build_sub_band_decoder_params(
        sub_band_encoder, [6, 6, 6, 6, 6, 6, 12, 16]
    )
